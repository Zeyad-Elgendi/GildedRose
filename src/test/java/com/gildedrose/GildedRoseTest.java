...
class GildedRoseTest {
    ...
    void normalItemsDegradesWithTime() {
        Item[] items = new Item[] { new Item("normal item", 4, 5) };
    ...
    void qualityIsNeverNegative() {
        Item[] items = new Item[] { new Item("normal item", 4, 0) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void normalItemSellInDecreasesByOne() {
        Item[] items = new Item[] { new Item("normal item", 4, 10) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(3, app.items[0].sellIn);
    }
    @Test
    void expiredItemsDegradeButNeverGoesLowerThan50() {
    ...
    void backstagePassesIncreaseByTwoLessThan10daysBeforeConcert2() {
        Item[] items = new Item[] { new Item("Backstage passes to a TAFKAL80ETC concert", 9, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(7, app.items[0].quality);
    }
